...
export default function HistoryDashboard() {
  ...
  const handleDelete = async (e: React.MouseEvent, id: string) => {
    // This stops the click from "bubbling up" to the Link component
    e.preventDefault();
    e.stopPropagation(); 
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-white flex items-center justify-center font-sans text-slate-500">
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-10 gap-6">
          <div>
            ...
            <p className="text-slate-500 font-medium mt-1">Revisit and manage your study sessions.</p>
          </div>
          ...
          <div className="relative w-full md:w-96">
            ...
            <input 
              ...
              className="pl-12 pr-6 py-4 bg-white border border-slate-200 rounded-2xl w-full outline-none focus:border-blue-500 shadow-sm"
        ...
        {filteredHistory.length > 0 ? (
            ...
            {filteredHistory.map((quiz) => (
              ...
              >
                <div className="flex justify-between items-start mb-5">
                  <div className="bg-blue-50 text-blue-700 px-3 py-1 rounded-full flex items-center space-x-2">
                    <Calendar size={12} />
                  ...
                  <button 
                    ...
                    className="p-2 text-slate-200 hover:text-red-500 hover:bg-red-50 rounded-xl transition-all relative z-50"
                  >
                    {deletingId === quiz.id ? (
                ...
                <h3 className="text-2xl font-extrabold mb-3 text-slate-800 line-clamp-2 group-hover:text-blue-600 transition-colors">
                ...
                <div className="mt-auto flex items-center justify-between pt-5 border-t border-slate-50">
                  <div className="flex items-center space-x-2 text-slate-400">
                    ...
                    <span className="text-xs font-black uppercase tracking-tighter">Practice Mode</span>
                  </div>
          ...
          <div className="text-center py-32 bg-white rounded-[40px] border-2 border-dashed border-slate-100 shadow-inner">
             <p className="text-slate-400 font-black text-xl mb-6">No quizzes found.</p>
             <Link 
               href="/" 
